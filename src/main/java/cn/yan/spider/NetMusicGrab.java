...
public class NetMusicGrab {
     ...
     * 获取歌曲列表
     */
    public static List<SongMsg> getSongList(String url, String charSet) {
        ...
        if (document != null) {
            ...
            System.out.println("json数据如下：" + resJson);
     ...
     * @return
     */
    public static List<Record> getRecordList(String url, String charSet) {
     ...
     * @return
     */
    private static Document getDocument(String url, String charSet) {
        //请求头
        ...
        String result = HttpClientUtil.doGet(url, headerList, charSet);
