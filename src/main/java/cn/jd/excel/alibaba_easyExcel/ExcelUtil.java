package cn.jd.excel.alibaba_easyExcel;
...
//                  f = t.getClass().getDeclaredField(attribute);
        ...
        File file = new File(xlsPath + File.separator + "cn/jd/excel");
        if (!file.exists()) {
            file.mkdirs();
        }
        //生成excel的文件路径
        String filePath=xlsPath + File.separator + "cn/jd/excel" + File.separator + "example.xls";
    ...
    public static void downLoadExcel(String filePath,String excelName,HttpServletResponse response) throws IOException{
        ...
        try {
            ...
            //设置导出文件名   
            String contentType = "application/vnd.ms-cn.jd.excel;charset=utf-8";
